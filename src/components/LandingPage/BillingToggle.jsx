...
export default function BillingToggle({ value, onChange }) {
  return (
    <div
      ...
      className="gradient-ring no-ring-hover relative flex h-11.5 w-83.25 shrink-0 items-center gap-2.5 rounded-pill shadow-[inset_0_0_0_1px_rgb(255_255_255/0.08)] bg-bg-card p-1.25"
    >
      <span
        aria-hidden="true"
