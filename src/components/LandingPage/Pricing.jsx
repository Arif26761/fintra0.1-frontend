...
export default function Pricing() {
  return (
    <section data-section="pricing" className="flex h-208.25 w-360 flex-col items-center gap-10">
      <div className="flex h-21 w-full items-center px-30.25">
        <div className="flex h-full w-299.5 flex-col items-center justify-between">
